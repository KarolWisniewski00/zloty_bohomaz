...
<main>
    ...
    <section id="top">
        <div class="jumbotron text-light bg-img rounded-0 shadow">
            <div class="header col-md-6 offset-md-3 my-12">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <div class="icon-artist container"><a href="https://www.instagram.com/biszusedziara/"><img src="assets/ig.png" alt="instagram-icon"></a></div>
                </div>
                <div class="col-lg-6">
                    <div class="artist-p my-2">
                    ...
                    <div class="icon-artist container"><a href="https://www.instagram.com/clim.tattoo/"><img src="assets/ig.png" alt="instagram-icon"></a></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="price" class="bg-black text-white">
        ...
        <div class="container">
            ...
            <div class="row no-gutters justify-content-center">
                <div class="col-md-3 p-3 price-h">
